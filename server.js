...
// Scheduler: ogni giorno alle 7:00
...
console.log(`⏰ Scheduler attivo: notifiche alle ${pushConfig.notificationTime.hour}:${String(pushConfig.notificationTime.minute).padStart(2, '0')}`);
