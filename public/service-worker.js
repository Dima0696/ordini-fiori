...
const CACHE_NAME = 'lombardaflor-orders-v155-no-matching';
const STATIC_CACHE = 'lombardaflor-static-v155-no-matching';
const API_CACHE = 'lombardaflor-api-v155-no-matching';
