...
const CACHE_NAME = 'lombardaflor-orders-v10-set-not-toggle';
const STATIC_CACHE = 'lombardaflor-static-v10-set-not-toggle';
const API_CACHE = 'lombardaflor-api-v10-set-not-toggle';
