...
const CACHE_NAME = 'lombardaflor-orders-v120-no-card-click';
const STATIC_CACHE = 'lombardaflor-static-v120-no-card-click';
const API_CACHE = 'lombardaflor-api-v120-no-card-click';
